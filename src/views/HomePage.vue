  ...
  <div id="homePage">
    <div class="container">
      <div class="hero-section">
        <h1 class="hero-title">AI应用生成平台</h1>
...
const loadMyApps = async () => {
  ...
  try {
    const res = await AppService.listMyAppVOByPage({
    ...
    if (res) {
      ...
      myAppsPage.total = Number(res.totalRow) || 0
    }
  } catch (error) {
...
const loadFeaturedApps = async () => {
  try {
    const res = await AppService.listGoodAppVOByPage({
    ...
    if (res) {
      ...
      featuredAppsPage.total = Number(res.totalRow) || 0
    }
  } catch (error) {
